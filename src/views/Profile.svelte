<script>
  import Tables from "./admin/Tables.svelte";
  // core components
  ...
  <main class="profile-page">
    <section class="relative block h-500-px">
      <div
        ...
        style="
          background-image: url(https://images.unsplash.com/photo-1625246333195-78d9c38ad449?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80);
        "
      >
        <span
          id="blackOverlay"
                ...
                <div class="flex flex-wrap justify-center">
                  <div class="w-full lg:w-9/12 px-4">
                    <p class="mb-4 text-lg leading-relaxed text-blueGray-700">
                      A Leader In value Addition of cereals and fresh farm
                      vegetables. Anything you need, we got you covered
                    </p>
                    <a
