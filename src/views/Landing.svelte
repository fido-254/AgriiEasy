  ...
  <main>
    ...
    >
      <div
        ...
        style="
          background-image: url(https://images.unsplash.com/photo-1574943320219-553eb213f72d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=791&q=80);
        "
      >
        <span
          id="blackOverlay"
          ...
          <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
            <div class="pr-12">
              ...
              <p class="mt-4 text-lg text-blueGray-200">
                A Platform that Connects farmers to a ready Marketplace in just
                a few easy steps.
              </p>
            </div>
          </div>
      ...
      <div class="container mx-auto px-4">
          ...
          <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
            ...
            >
              <div class="px-4 py-5 flex-auto">
                ...
                <h6 class="text-xl font-semibold">I'm A Farmer</h6>
                <p class="mt-2 mb-4 text-blueGray-500">
                  I'm happy to be able to supply my quality farm produce through
                  the AgriEasy platform with no hastle.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="w-full md:w-4/12 px-4 text-center">
            ...
            >
              <div class="px-4 py-5 flex-auto">
                ...
                <h6 class="text-xl font-semibold">We are an Organisation</h6>
                <p class="mt-2 mb-4 text-blueGray-500">
                  Having acces to a ready market not only with fresh produce but
                  with reliable vendors has never been so easy.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="pt-6 w-full md:w-4/12 px-4 text-center">
            ...
            >
              <div class="px-4 py-5 flex-auto">
                ...
                >
                  <i class="fas fa-basket-shopping-s" />
                </div>
                <h6 class="text-xl font-semibold">I'm a Consumer</h6>
                <p class="mt-2 mb-4 text-blueGray-500">
                  I'm happy to get what I want when I want it never compromising
                  on the farm fresh quality and delivery reliability
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="flex flex-wrap items-center mt-32">
          <div class="w-full md:w-5/12 px-4 mr-auto ml-auto">
            ...
            >
              Get quick access to a ready Market poppulated not only with small
              scale consumers but also International Companies
            </p>
            <p
              class="text-lg font-light leading-relaxed mt-0 mb-4 text-blueGray-600"
            >
              Enjoy a wide Variety of fresh products straight from the farm to
              the convenience of your home / business
            </p>
            <a use:link href="/" class="font-bold text-blueGray-700 mt-8">
              Thanks for trusting AgriEasy
            </a>
          </div>
            ...
            >
              ...
              <blockquote class="relative p-8 mb-4">
                ...
                <p class="text-md font-light mt-2 text-white">
                  Enjoy top Notch services right from Ordering from the Farm to
                  the Delivery at your Doorstep
                </p>
              </blockquote>
            </div>
          </div>
      ...
      <div class="container mx-auto px-4 lg:pt-24 lg:pb-64">
        <div class="flex flex-wrap text-center justify-center">
          <div class="w-full lg:w-6/12 px-4">
            ...
            <p class="text-lg leading-relaxed mt-4 mb-4 text-blueGray-400">
              Chose below a a ctegory that that best suits you and well help in
              your journey of Revolutionising the Agricultural Sector.
            </p>
          </div>
        </div>
        <div class="flex flex-wrap mt-12 justify-center">
          <div class="w-full lg:w-3/12 px-4 text-center">
            ...
            <h6 class="text-xl mt-5 font-semibold text-white">I'm A Farmer</h6>
            <p class="mt-2 mb-4 text-blueGray-400">
              With the ability to deliver the listed variety of farm produce on
              my Profile.
            </p>
          </div>
          <div class="w-full lg:w-3/12 px-4 text-center">
            ...
            <p class="mt-2 mb-4 text-blueGray-400">
              Looking to buy farm produce in bulk from the Listed Inventories on
              AgriEasy.
            </p>
          </div>
          <div class="w-full lg:w-3/12 px-4 text-center">
            ...
            <p class="mt-2 mb-4 text-blueGray-400">
              In need of Fresh Farm produce as per my Specifications.
            </p>
          </div>
        </div>
      </div>
